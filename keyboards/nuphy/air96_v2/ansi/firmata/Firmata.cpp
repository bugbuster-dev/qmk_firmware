  ...
  parser(FirmataParser(parserBuffer, MAX_DATA_BYTES))
{
  ...
  memset(firmwareVersionVector, 0, sizeof(firmwareVersionVector));
...
void FirmataClass::setFirmwareNameAndVersion(const char *name, byte major, byte minor)
{
  ...
  memset(firmwareVersionVector, 0, sizeof(firmwareVersionVector));
  if (firmwareVersionCount > sizeof(firmwareVersionVector)-1) {
    firmwareVersionCount = sizeof(firmwareVersionVector)-1;
  }
